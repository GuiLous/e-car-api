...
RSpec.describe AssistantSubmissionServices::AcceptService do
  describe '#accept' do
    it 'create assistant and assistant service' do
      ...
      submission = Fabricate(:assistant_submission, user: user, status: :pending, title: 'I am an assistant', description: 'xpto', modality: 0, price: 100, service_category_id: service_category.id)
